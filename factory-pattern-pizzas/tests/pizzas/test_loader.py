...
class TestPizzaFactory: 
    ...
    def test_load_veggie_pizza(self): 
        pizza = PizzaFactory.create_pizza("veggie")
    ...
    def test_load_pepperoni_pizza(self): 
    ...
    def test_return_null_for_unknown_pizza(self): 
        pizza = PizzaFactory.create_pizza("this_pizza_should_never_exist_123493297923tye98wyf")
